#ifndef MENOH_IMPL_NAIVE_OPERATOR_RELU_HPP
#define MENOH_IMPL_NAIVE_OPERATOR_RELU_HPP
...
namespace menoh_impl {
    namespace naive_backend {
        ...
        make_relu(int32_t i, std::vector<node> const& node_list,
                  std::unordered_map<std::string, array> const& variable_table);

    } // namespace naive_backend
} // namespace menoh_impl

#endif // MENOH_IMPL_NAIVE_OPERATOR_RELU_HPP
