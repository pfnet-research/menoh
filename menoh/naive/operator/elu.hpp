#ifndef MENOH_IMPL_NAIVE_OPERATOR_ELU_HPP
#define MENOH_IMPL_NAIVE_OPERATOR_ELU_HPP
...
namespace menoh_impl {
    namespace naive_backend {
        ...
        computation_node_factory_return_type make_elu(
...
#endif // MENOH_IMPL_NAIVE_OPERATOR_ELU_HPP
