#ifndef MENOH_IMPL_NAIVE_OPERATOR_SUM_HPP
#define MENOH_IMPL_NAIVE_OPERATOR_SUM_HPP
...
namespace menoh_impl {
    namespace naive_backend {
        ...
        computation_node_factory_return_type make_sum(
...
#endif // MENOH_IMPL_NAIVE_OPERATOR_SUM_HPP
