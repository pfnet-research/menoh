#ifndef MENOH_IMPL_NAIVE_OPERATOR_ADD_HPP
#define MENOH_IMPL_NAIVE_OPERATOR_ADD_HPP
...
namespace menoh_impl {
    namespace naive_backend {
        ...
        computation_node_factory_return_type make_add(
...
#endif // MENOH_IMPL_NAIVE_OPERATOR_ADD_HPP
